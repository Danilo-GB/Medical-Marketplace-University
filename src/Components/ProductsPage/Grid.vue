      ...
      <div class="row col-6 pb-4 pr-1">
        <div class="dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
            ...
            <a class="dropdown-item" @click="sortTrend">Destacado</a>
          </div>
        </div>
      </div>
        ...
        <div class="view-button">
          <div class="dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="MenuLink">
              <a class="dropdown-item" @click="sortI('insumos')">Insumos</a>
              <a class="dropdown-item" @click="sortI('desechables')"
                >Desechables</a
              >
              <a class="dropdown-item" @click="sortI('equipos')">Equipos</a>
              <a class="dropdown-item" @click="sortI('servicios')">Servicios</a>
          ...
          <div class="card-selector">
            <div class="card-body p-5">
              <div class="search-title">
                <h4>Categorías</h4>
                <br />
                <h6 @click="sortI('insumos')">Insumos</h6>
                <h6 @click="sortI('desechables')">Desechables</h6>
                <h6 @click="sortI('equipos')">Equipos</h6>
                <h6 @click="sortI('servicios')">Servicios</h6>
                <br /><br /><br />
                <br /><br />
...
export default {
  ...
  methods: {
    ...
    sortTrend() {
      ...
      return (this.sortButton = "destacado");
    },
    sortI(name) {
